...
class AdapterCategories(val categories: ArrayList<ResponseCategory>, private val itemClickListener: RVOnItemClickListener,val postCategories: ArrayList<ResponseCategory>) :
  ...
  if(MyApplication.languageCode==AppConstants.LANG_ENGLISH){
      ...
      try{AppHelper.setImageResize(holder.itemView.context,holder.ivCategoryImage,AppConstants.IMAGES_URL+categories[position].iconPathAr!!,200,200) }catch (e:java.lang.Exception){}
