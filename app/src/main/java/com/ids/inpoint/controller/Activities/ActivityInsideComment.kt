...
class ActivityInsideComment : AppCompactBase(),RVOnItemClickListener {
    ...
    private fun initialize(){
        ...
        llnewsFeed.setOnClickListener {
          /*  MyApplication.uponEntry = true
            startActivity(Intent(this, ActivityHome::class.java))*/

            if (MyApplication.userLoginInfo.id!! == MyApplication.selectedPostUserId!!) {
                ...
                MyApplication.selectedPost.userId=MyApplication.selectedPostUserId
