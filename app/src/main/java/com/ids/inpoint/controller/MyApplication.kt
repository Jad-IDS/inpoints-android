...
class MyApplication : Application() {
    companion object {
        ...
        var arrayFolders = java.util.ArrayList<ResponseFolders>()
        var arraySharedPosts = java.util.ArrayList<ResponsePost>()
        lateinit var selectedPost: ResponsePost
        var selectedPostUserId:Int?=null
        ...
        var work_item_selected : String ?=null
        ...
        var arrayEmploymentList =   ArrayList<ResponseLocations>()
        var arrayJobTypes =   ArrayList<ResponseLocations>()
        var arraySupportsType =   ArrayList<ResponseLocations>()
        var arrayUsers = ArrayList<ResponseUser>()
        var arrayArticlesType = ArrayList<ResponseLocations>()
        ...
        var arrayFollowing = ArrayList<ResponseFollowers>()
        ...
        var userInfo:ResponseUserInfos?=null
