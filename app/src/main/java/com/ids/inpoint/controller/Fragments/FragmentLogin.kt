...
class FragmentLogin : Fragment() , RVOnItemClickListener {
    ...
    private fun init(){
       etUsrname.setText("i.haydar@ids.com.lb")
        ...
        cbAccount.setOnClickListener {

            if(cbAccount.isChecked) {
                etUsrname.setText("jhhgooner@gmail.com")
                etPassword.setText("P@ssw0rd123")
            }
            else{
                etUsrname.setText("i.haydar@ids.com.lb")
                etPassword.setText("0xUR_HBQM[iiex")
...
/*
    ...
    private fun onValidateRetrieved( response: Response<ResponseUserInfos>) {
        ...
        MyApplication.userLoginInfo.email = etUsrname.text.toString()
