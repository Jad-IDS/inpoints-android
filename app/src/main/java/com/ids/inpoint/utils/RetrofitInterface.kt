...
interface RetrofitInterface {
    ...
    @GET("Api/UserProfile/CanViewProfileImage")
    fun canViewProfileImage(
        @Query(ApiParameters.IMAGE_USER_ID) id: Int
    ):Call<Boolean>
    ...
    @POST("Api/UserProfile/DeactivateAccount")
    fun DeactivateAccount(
        @Query(ApiParameters.PERMANENT_DEACTIVATION) permanent:Boolean
    ) : Call<Boolean>
    ...
    @GET("Api/UserProfile/UpdateEmail")
    fun updateEmail(
        @Query(ApiParameters.NEW_EMAIL) new: String,
        @Query(ApiParameters.PASSWORD) pass : String,
        @Query(ApiParameters.OLD_EMAIL) old: String
    ): Call<String>
    ...
    @GET("Api/UserProfile/GetUserFollowings")
    fun getFollowing( @Query(ApiParameters.PAGE_USER_ID) id: Int): Call<ArrayList<ResponseFollowers>>
...
/*    @GET("Api/EventFunding/event/{id}")
    ...
    fun getTeamFiles(
        @Query(ApiParameters.TEAM_ID) id: Int,
        @Query(ApiParameters.FOLDER) folder: String
    ...
    @DELETE("Api/Utility/DeleteFolder")
    fun deleteFolder(@Query(ApiParameters.FOLDER_NAME) folderName:String): Call<Void>


    @POST("Api/Utility/RenameFolders")
    fun renameFolder(
        @Query(ApiParameters.OLD_NAME) oldName:String,
        @Query(ApiParameters.NEW_NAME) newName:String
...
/*    @POST("Api/UserProfile/UpdateUserName")
    ...
    @GET("Api/Utility/GetFolders")
    fun getFolders(): Call<ArrayList<ResponseFolders>>

    @POST("Api/Utility/CreateFolder")
    fun creatFolder(@Query(ApiParameters.FOLDER_NAME) folder: String): Call<String>

    @POST("Api/Post/SharPostOnTimeLine")
    fun shareTimeline(@Query(ApiParameters.POST_ID) postId: Int): Call<Void>
